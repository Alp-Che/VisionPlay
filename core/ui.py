...
class _MouseClicks:
    ...
    def _record(self, event, x, y, flags, param):
        # OpenCV hands the click over already in the picture's own
        # coordinates, however the window is sized or put full screen -- the
        # Windows, macOS and Linux back ends all do the conversion themselves.
        # Scaling it again here is what put a click on KÖSTEBEK onto ÇİZİM in
